...
After to install a GEM need create a file named onfig/databasedotcom.yml
In databasedotcom.yml you need insert the configuration, like so:
...
After set file <b>databasedotcom.yml</b>, you can use the GEM.

=HOW TO USE?

If you can see the list of leads you have you can do this: <b>LeadCreate.list_leads</b>
If you can save a new lead in your salesforce account, you can do this: <b>LeadCreate.create(contact)</b>
