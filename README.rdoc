...
After set file databasedotcom.yml, you can use the GEM.

=HOW TO USE?

If you can see the list of leads you have you can do this: LeadCreate.list_leads
